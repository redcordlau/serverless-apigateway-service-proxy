...
describe('#validateServiceProxies()', () => {
  ...
  describe('kinesis', () => {
    ...
    it('should not throw error if requestModels and requestValidatorId exist', () => {
      serverlessApigatewayServiceProxy.serverless.service.custom = {
        apiGatewayServiceProxies: [
          {
            kinesis: {
              ...
              path: 'kinesis',
              method: 'post',
              requestModels: { 'application/json': 'yourRequestModels' },
              requestValidatorId: 'yourRequestValidator',
              request: { template: { 'application/json': 'mappingTemplate' } }
            }
          }
        ]
    ...
    it('should throw error if requestModels is not an object', () => {
      serverlessApigatewayServiceProxy.serverless.service.custom = {
        apiGatewayServiceProxies: [
          {
            kinesis: {
              ...
              path: 'kinesis',
              method: 'post',
              requestModels: 'yourRequestModels',
              request: { template: [] }
            }
          }
        ]
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        serverless.classes.Error,
        'child "kinesis" fails because [child "requestModels" fails because ["requestModels" must be an object]]'
      )
    })

    it('should throw error if requestValidatorId is not a Ref', () => {
      serverlessApigatewayServiceProxy.serverless.service.custom = {
        apiGatewayServiceProxies: [
          {
            kinesis: {
              ...
              path: 'kinesis',
              method: 'post',
              requestValidatorId: { requestValidatorId: 'yourRequestValidatorId' },
              request: { template: [] }
            }
          }
        ]
      ...
      expect(() => serverlessApigatewayServiceProxy.validateServiceProxies()).to.throw(
        serverless.classes.Error,
        'child "kinesis" fails because [child "requestValidatorId" fails because ["requestValidatorId" must be a string, child "Ref" fails because ["Ref" is required]]]'
      )
    })
